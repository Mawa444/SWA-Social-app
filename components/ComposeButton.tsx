...
const ComposeButton: React.FC<ComposeButtonProps> = ({ onClick }) => (
  <div className="fixed bottom-32 right-6 z-50 md:right-12">
    <button 
      onClick={onClick}
      className="bg-[#FF416C] w-20 h-20 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-90 transition-all border-4 border-white/20"
    >
